...
SUPPORTED_PROTOCOLS = ['Env','Ow','Lemi','Arduino','GSM90','GSM19','Cs','POS1','MySQL','Lm','Lnm','BM35','Test','GP20S3','cr1000jc','ad7714'] # should be provided by MagPy
"""
Protocol types:
...
current work    Test    : active                : random number
